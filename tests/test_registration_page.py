...
def test_valid_input_data(register_page_driver):
    ...
    email_field.send_keys(f"lol@kek.qu")
    ...
    WebDriverWait(register_page_driver, 3).until(expected_conditions.presence_of_element_located((By.XPATH, Xpath.LoginPage.recover_pass_href)))
